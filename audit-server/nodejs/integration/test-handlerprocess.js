	...
	handler.on('message', function(m) {
		switch(m.type) {
			...
			case 'REQUEST_END':
				test.equal(
					output,
					'<?xml version="1.0" encoding="UTF-8"?>\n<configuration><property><name>fs.default.name</name><value>hdfs://localhost:8025/</value></property><property><name>auditable.mapreduce.sessionToken</name><value>01234567-test-0123-0123</value></property></configuration>\n',
